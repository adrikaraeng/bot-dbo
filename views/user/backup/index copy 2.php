...
<div id="case-telegram">
  ...
  <div style="position:fixed;left:5px;top:70px;">
  ...
  <?php if($model != NULL):?>    
  <div style="top:70px;position:fixed;right:30px;">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-12">
          ...
          <div style="text-align:right;float:right;">
            ...
            <div class="form-group" style="text-align:center;float:right;padding-left:20px;">
