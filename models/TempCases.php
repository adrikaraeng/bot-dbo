...
/**
 * This is the model class for table "temp_cases".
 *
 * @property int $id
 ...
 * @property string|null $tanggal_closed
 */
class TempCases extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['login', 'kategori', 'sub_kategori', 'backend', 'channel', 'sub_channel', 'closed_by'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'status_owner' => Yii::t('app', 'Status Owner'),
